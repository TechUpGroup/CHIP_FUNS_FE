  ...
  function PaginationEllipsis(props, ref) {
    ...
    return (
      <ChakraPagination.Ellipsis ref={ref} {...props} asChild>
        <Button as="span" variant={variantMap.ellipsis} size={size} bg="#1E2127" color="white">
  ...
  function PaginationItem(props, ref) {
    ...
    return (
      <ChakraPagination.Item ref={ref} {...props} asChild>
        <Button variant={variant} size={size} border="unset" color="white" bg={current ? '#96F048' : '#1E2127'}>
          {props.value}
        </Button>
